...
typeset RcsId="$Id: lcntProc.sh,v 1.1 2019-04-22 17:47:39 lsipusr Exp $"
# *CopyLeft*
...
"
FILE="
*  /This File/ :: /lcnt/lgpc/bystar/permanent/facilities/contentProductionExample/lcntProc.sh 
"
if [ "${loadFiles}" == "" ] ; then
